...
urlpatterns = patterns('',
    ...
    url(
        regex=r'^friend/accept/(?P<friendship_request_id>[\w-]+)/$',
        view=friendship_accept,
        name='friendship_accept',
    ),
    url(
        regex=r'^friend/reject/(?P<friendship_request_id>[\w-]+)/$',
        view=friendship_reject,
        name='friendship_reject',
    ),
    url(
        regex=r'^friend/cancel/(?P<friendship_request_id>[\w-]+)/$',
    ...
    url(
        regex=r'^friend/request/(?P<friendship_request_id>[\w-]+)/$',
