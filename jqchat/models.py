...
class Room(models.Model):
    ...
    content_type=models.TextField(models.ForeignKey(ContentType,  blank=True, null=True))
    object_id = models.PositiveIntegerField(blank=True, null=True)
    content_object = generic.GenericForeignKey()
    participants = models.TextField(help_text='participants list (each user that takes part in conversation) seperated by : ')
...
class Message(models.Model):
    ...
    """
    user=models.TextField(models.ForeignKey(AUTH_USER_MODEL))
    room=models.TextField(models.ForeignKey(Room, help_text='This message was posted in a given chat room.'))
    ...
    def save(self, **kw):
        ...
        self_room = Room.objects.get(name=self.room)
        self_room.last_activity = int(time.time())
        self_room.save()
...
class RoomMember(models.Model):
    """A room member"""
    user=models.TextField(models.ForeignKey(AUTH_USER_MODEL))
    room=models.TextField(models.ForeignKey(Room, null=True))    
